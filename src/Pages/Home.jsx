...
const WORDS = ["Imformation Technology Enginnering Student", "Frontend Developer", "UI/UX Designer"];
const TECH_STACK = ["Html", "Css", "Laravel", "React.js", "Node.js", "Tailwind", "Next.js" ,"Figma"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/khornSaokhouch" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/khorn-saokhouch-702026326/" },
  { icon: Instagram, link: "https://www.instagram.com/khouch_fc?igsh=MWpxN2YzdGg1bWpkeg==" }
];
